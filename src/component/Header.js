        ...
        <>
            <div className={"header d-flex justify-content-between flex-wrap align-items-center"}>
                ...
                <div className={"climate-lab d-flex align-items-center"}>
                    ...
                    <a className={"d-flex align-items-center climate-lab-link"} href="https://climatelab.fr"><img height={27} width={27} className={"logo-img mr-1"} src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/285/alembic_2697-fe0f.png" alt="Alambic"/> ClimateLab</a>
                </div>
